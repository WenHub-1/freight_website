      ...
      <div className="absolute -bottom-8 md:-bottom-14  ">
        ...
        >
          ...
          <div className="relative  p-4  sm:p-8 md:p-12 flex flex-col gap-4 sm:gap-7">
            ...
            <Button className="text-base rounded md:rounded-lg  sm:text-lg h-10 w-[135px] sm:h-12 sm:w-44 md:h-14 md:w-[210px] font-semibold sm:font-medium">
              {/* Text for screens ABOVE sm */}
              <span className="hidden sm:inline">Download the app</span>

              {/* Text for screens BELOW sm */}
              <span className="inline sm:hidden">Download app</span>
            </Button>
          </div>
