...
const QaddamLogoLarge: React.FC = () => (
  <svg
    width="130"
    height="150"
    viewBox="0 0 120 150"
    ...
    className="drop-shadow-[0_0_30px_rgb(var(--primary-rgb)_\/_0.4)]"
  >
    <path
      d="M60 8C34 8 12 30 12 56C12 90 60 142 60 142C60 142 108 90 108 56C108 30 86 8 60 8Z"
      fill="#1A2B3C"
    />
    <path d="M60 8C34 8 12 30 12 56C12 78 36 112 60 142V8Z" fill="#7DC21E" />
